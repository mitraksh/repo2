...
const packagerepo1 = require('../repo1/package.json');
...
async function main() {
  ...
  try {
    ...
    const repo1_version = packagerepo2.version;
    let result1 = await fs.readFile(repo1ObjPath, "utf8");
    console.log(result)
    result = JSON.parse(result);
